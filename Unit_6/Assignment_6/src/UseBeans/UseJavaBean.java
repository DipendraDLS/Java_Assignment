 ...
 * @author dipen
 */
public class UseJavaBean extends javax.swing.JFrame {

    /**
     * Creates new form UseJavaBean
     */
    public UseJavaBean() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        rectangle1 = new Q01_JavaBean.Rectangle();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        rectangle1.setBreadth(100);
        rectangle1.setLength(200);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UseJavaBean.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UseJavaBean().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private Q01_JavaBean.Rectangle rectangle1;
